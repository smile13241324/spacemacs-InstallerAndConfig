...
sudo apt-get install libncurses5-dev git silversearcher-ag silversearcher-ag-el curl wget vim build-essential cmake python-dev python3-dev libgtk-3-dev libwebkitgtk-3.0-dev libgtk-3-common libgtk-3-0
...
sudo apt-get install clang clang-format clang-tidy libclang libclang-dev libc++ libc++-dev libc++-helpers libc++abi libc++abi-dev clang-modernize libclang-common-dev libclang-common libboost-all-dev libboost-all lldb llvm 
