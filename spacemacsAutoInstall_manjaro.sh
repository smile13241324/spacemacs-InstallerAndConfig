...
if [[ $1 ]]; then
    ...
    pacman -S cabal-install alex ghc ghc-static happy haskell-abstract-deque                \
           ...
           haskell-concurrent-output haskell-conduit              \
           ...
           haskell-ghc-paths haskell-gitrev haskell-glib haskell-glob  \
           ...
           haskell-here haskell-heredoc haskell-hex haskell-hinotify        \
           haskell-hjsmin haskell-hledger-lib haskell-hopenpgp haskell-hostname  \
           ...
           haskell-juicypixels haskell-kan-extensions haskell-keys               \
           ...
           haskell-securemem haskell-semigroupoids haskell-servant        \
