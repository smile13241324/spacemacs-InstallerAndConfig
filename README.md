...
Notice that the haskell support has been moved to a separate [repository](https://github.com/smile13241324/spacemacs-InstallerAndConfig-haskell) due to exceeding the maximum build time on docker hub.
If you wish for haskell development support please use the alternate image being based on this one.
